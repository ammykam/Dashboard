        ...
        for batch in batches:
            ...
            for line in lines:
              ...
              try:
                ...
                key_words=['sydney gay and lesbian mardi gras','lgbtq','pridemonth','pride month','lgbtqiaplus','lgbtpride','lgbtcommunity','sydneyworldpride','gay','lesbian','bisexual','transgender','loveislove','rainbow','sydneygay','gayaustralia','nonbinary','gbtqcommunity','queer','transrightsarehumanrights']
                if line_json['doc']['data']['context_annotations'][2]['entity']['name']=='Sydney Gay and Lesbian Mardi Gras' or any(item in text for item in key_words)or any(item in tags for item in key_words):
